...
# Lasza, 
Lasza = el.CT_1x100_F2
Lasza.rotate(0)

# MBB for 2nd and 3th panel
PC_MBB1 = tntS.generateNodes([(Lasza,100,1),(MBB, 600, 8)]) 
...
Panel3 = tntP.PCPanel(MBB=PC_MBB1,
                     VBB=PC_VBB2,
                     Load=False,
                     Air=None,
                     T0=25)

Panel4 = tntP.PCPanel(MBB=PC_MBB1,
                     VBB=PC_VBB2,
                     Load=False,
                     Air=None,
                     T0=25)
...
Panel3.set3I(Iin=3800,
             Iout=1900,
             Ifeeder=1900)

Panel4.set3I(Iin=1900,
             Iout=0,
             Ifeeder=1900)
...
Time, T, Stp, Nodes = tntS.PanelSolver(Lineup, 20, 6*60*60, 
                iniTimeStep = 1,
